...
(*
  Ce test regarde si on a géré le cas des doublons de candidats et de formations.
  On test aussi si le candidat ajoute une formation inexistante.
*)
