...
(* Les candidats refusent tous leurs choix de formations *)
...
let () = 
  ...
  renonce session  ~nom_candidat:"Adam"  ~nom_formation:"Université de Toulon";
  renonce session  ~nom_candidat:"Adam"  ~nom_formation:"Université Côte d'Azur";
  renonce session  ~nom_candidat:"Béatrice"  ~nom_formation:"Université de Toulon";
  renonce session  ~nom_candidat:"Béatrice"  ~nom_formation:"Université Côte d'Azur";
  nouveau_jour session;
  affiche_voeux_en_attente session "Adam";
  affiche_propositions_en_attente session "Adam";
  affiche_voeux_en_attente session "Béatrice";
